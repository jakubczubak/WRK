            ...
            <form:form method="post" modelAttribute="order">
                ...
                <div class="form-group" id="checkboxes">
                    <c:forEach var="part" items="${galvanicCoating}">
                        <form:checkbox path="galvanicCoating" cssClass="custom-checkbox"
                                       value="${part}"></form:checkbox>${part}<br>
                    </c:forEach>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <form:textarea path="details" class="form-control" id="exampleFormControlTextarea1"
