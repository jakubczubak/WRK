...
//       .antMatchers("/**").permitAll()
    ...
    public DriverManagerDataSource dataSource() {
        ...
        driverManagerDataSource.setUrl("jdbc:mysql://us-cdbr-iron-east-02.cleardb.net/heroku_8baac64cc903001?reconnect=true");
        driverManagerDataSource.setUsername("b9a5a38b083d21");
        driverManagerDataSource.setPassword("cc66ecc2");
